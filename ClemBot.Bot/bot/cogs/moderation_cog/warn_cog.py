...
class WarnCog(commands.Cog):
    ...
    @ext.command()
    @ext.long_help("Warns a user and applies an infraction to them")
    ...
    async def warn(self, ctx: ext.ClemBotContext[ClemBot], subject: discord.Member, *, reason: str):
        ...
        await self.bot.messenger.publish(
            Events.on_bot_warn, guild=ctx.guild, author=ctx.author, subject=subject, reason=reason
        )
