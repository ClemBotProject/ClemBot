...
class OwnerCog(commands.Cog):
    ...
    async def add(self, ctx: ext.ClemBotCtx, channel_type: str, channel: discord.TextChannel):
        ...
        if DesignatedChannels.has(channel_type):
            await ctx.send(
                f"The requested designated channel `{channel_type}` is not an owner channel"
            )
            return
        ...
        embed = discord.Embed(title="Owner Designated Channel added", color=Colors.ClemsonOrange)
        embed.add_field(
    ...
    async def delete(self, ctx: ext.ClemBotCtx, channel_type: str, channel: discord.TextChannel):
        ...
        embed = discord.Embed(title="Owner Designated Channel deleted", color=Colors.ClemsonOrange)
        embed.add_field(
    ...
    async def count(self, ctx):
        ...
        embed.add_field(
            name="Users", value=sum(len(i.members) for i in self.bot.guilds), inline=False
        )
