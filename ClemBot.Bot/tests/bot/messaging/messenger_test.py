...
class TestMessenger:
    ...
    @pytest.mark.asyncio
    async def test_publish_event_queue_two_event_one_guild_invokes_two_listeners_in_order_doesnt_fail_on_exception(
        self,
    ):
        messenger = Messenger()
    ...
    @pytest.mark.asyncio
    async def test_publish_event_queue_event_one_guild_invokes_two_listeners_in_order_doesnt_fail_on_exception(
        self,
    ):
        messenger = Messenger()
    ...
    @pytest.mark.asyncio
    async def test_publish_event_queue_two_event_one_guild_invokes_two_listeners_in_order_invokes_error_callback_on_error(
        self,
    ):
        messenger = Messenger()
    ...
    @pytest.mark.asyncio
    async def test_publish_event_queue_event_one_guild_invokes_one_listeners_in_order_invokes_error_callback_on_error(
        self,
    ):
        messenger = Messenger()
        error_call_state = []
    ...
    @pytest.mark.asyncio
    async def test_publish_event_queue_event_one_guild_invokes_two_listeners_in_order_invokes_twice_error_callback_on_error(
        self,
    ):
        messenger = Messenger()
        error_call_state = []
    ...
    @pytest.mark.asyncio
    async def test_publish_event_queue_event_one_guild_invokes_two_listeners_in_order_invokes_twice_error_callback_on_error_twice(
        self,
    ):
        messenger = Messenger()
        error_call_state = []
    ...
    @pytest.mark.asyncio
    async def test_publish_event_queue_event_one_guild_invokes_two_listeners_in_order_invokes_once_error_callback_on_error(
        self,
    ):
        messenger = Messenger()
        error_call_state = []
