...
def configure_from_file(file_name: Any, override_root_logger: bool = ..., use_structured_logger: bool = ...) -> None: ...
def configure_from_dict(config: Any, override_root_logger: bool = ..., use_structured_logger: bool = ...) -> None: ...
def log_to_seq(server_url: Any, api_key: Incomplete | None = ..., level: Any = ..., batch_size: int = ..., auto_flush_timeout: Incomplete | None = ..., additional_handlers: Incomplete | None = ..., override_root_logger: bool = ..., json_encoder_class: Incomplete | None = ..., **kwargs: Any) -> Any: ...
